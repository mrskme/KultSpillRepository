...
namespace KultSpillHahaHeheHohoDualYolo
{
    class Spawner
    {
        ...
        //};
        //public static List<EnemyRectangle> SecondLevelEnemies = new List<EnemyRectangle>
        //{
        //    new EnemyRectangle(Color.Aqua, 50, 100, "down", 16, 40, 40, 1000),
        //    new EnemyRectangle(Color.Coral, 150, 200, "right", 23, 40, 40,500),
        //    new EnemyRectangle(Color.Crimson, 350, 200, "down", 8, 40, 40, 800),
        //    new EnemyRectangle(Color.Black, 350, 200, "down", 8, 40, 40, 800),
        //};
        //public static List<Platform> FirstLevelPlatforms = new List<Platform>
        //{

        //};
        //public static List<Platform> SecondLevelPlatforms = new List<Platform>
        //{
        ...
        //    {
        //        new GameLevel(ChosenPlayer, FirstLevelEnemies, FirstLevelPlatforms, CreateRandomCoins(0), InvisibleWallsList),
        //        new GameLevel(ChosenPlayer, SecondLevelEnemies, FirstLevelPlatforms, CreateRandomCoins(0), InvisibleWallsList),
        //    };
        //}
    }
}
